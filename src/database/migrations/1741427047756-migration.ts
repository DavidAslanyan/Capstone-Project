...
export class Migration1741427047756 implements MigrationInterface {
    name = 'Migration1741427047756'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255), "password" character varying(255) NOT NULL, "difficulty_level" "public"."user_difficulty_level_enum" NOT NULL, "role" "public"."user_role_enum" NOT NULL, "status" "public"."user_status_enum" NOT NULL, "progress" integer NOT NULL, "coins" integer NOT NULL, "games_passed" text array, "avatar" character varying(255) NOT NULL, "frame" character varying(255) NOT NULL, "background" character varying(255) NOT NULL, "avatars_purchased" text array, "frames_purchased" text array, "backgrounds_purchased" text array, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
